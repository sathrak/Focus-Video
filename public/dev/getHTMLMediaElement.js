...
function getHTMLMediaElement(mediaElement, config) {
    ...
    var mainContainer = document.getElementById('main-media');
    var mediaControls = document.createElement('ul');
    mediaControls.className = "mb-0";
    //mediaControls.className = 'media-controls';
    mainContainer.appendChild(mediaControls);
   //mediaElementContainer.appendChild(mediaControls);

    if (buttons.has('mute-audio')) {
        var muteAudio = document.createElement('li');
        muteAudio.className = 'control ' + (config.toggle.has('mute-audio') ? 'unmute-audio selected' : 'mute-audio');
        var autoimg = document.createElement('i');
        autoimg.className = 'fas fa-microphone';
        muteAudio.appendChild(autoimg);
    ...
    if (buttons.has('mute-video')) {
        var muteVideo = document.createElement('li');
        muteVideo.className = 'control ' + (config.toggle.has('mute-video') ? 'unmute-video selected' : 'mute-video');
        var videoimg = document.createElement('i');
        videoimg.className = 'fas fa-video';
        muteVideo.appendChild(videoimg);
