...
// Last time updated: 2020-08-21 4:26:11 PM UTC
/**********************************************************************************************
 *	Filename	: server.js							
 *	Author		: Sathrak paldurai K
 *	Date		: 26-07-2020								
 *	Description	: Video Chat Server.// RTCMultiConnection v3.6.9
***********************************************************************************************/
...
var RTCMultiConnection = function(roomid, forceOptions) {
    ...
    function SocketConnection(connection, connectCallback) {
        ...
        function onMessageEvent(message) {
            console.log("onMessageEvent============",message);
    ...
    function MultiPeers(connection) {
        ...
        console.log("TextReceiver===========",typeof 'TextReceiver');
    ...
    (function(connection) {
        ...
        connection.userid = getCookie("FSID");//getRandomString();
        connection.changeUserId = function(newUserId, callback) {
            callback = callback || function() {};
            connection.userid = newUserId || getCookie("FSID");//getRandomString();
        ...
        connection.onstream = function(e) {
            console.log("videoHeight===1========",e.mediaElement.videoHeight);
            console.log("videoWidth====1=======",e.mediaElement.videoWidth);
        ...
        connection.invokeGetUserMedia = function(localMediaConstraints, callback, session) {
            ...
            console.log("localMediaConstraints===========",localMediaConstraints);
            getUserMediaHandler({
        ...
        connection.onUserIdAlreadyTaken = function(useridAlreadyTaken, yourNewUserId) {
            ...
            connection.isInitiator = false;
            connection.userid = getCookie("FSID");//connection.token();
